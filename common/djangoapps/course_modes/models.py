...
class CourseMode(models.Model):
    ...
    @classmethod
    def has_masters_mode(cls, modes_dict):
        """
        Check whether the modes for a course contain a Master's mode.

        Args:
            modes_dict (dict): course modes

        Returns:
            bool: whether modes contain a Master's mode
        """
    ...
    def is_masters_only(cls, course_id):
        ...
        return cls.has_masters_mode(modes) and len(modes) == 1
